...
def test_benchmark():
    ...
    print('Naive method (repeat={}): {} sec'.format(repeat, naive_time))
    print('Tile method using stride={} (repeat={}): {} sec'.format(tile_size, repeat, tile_time))
    print('mkl method (repeat={}): {} sec\n'.format(repeat, mkl_time))

    print('Tile speed-up over naive: {} x'.format(tile_over_naive))
    print('mkl speed-up over naive: {} x'.format(mkl_over_naive))

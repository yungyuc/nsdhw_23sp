...
PYBIND11_MODULE(_matrix, m) {
    ...
    py::class_<Matrix>(m, "Matrix")
        ...
        .def_property_readonly("array", [](const Matrix& mat){ return py::array_t<double>({mat.nrow(), mat.ncol()}, {sizeof(double)*mat.ncol(), sizeof(double)}, mat.data(), py::cast<const Matrix*>(&mat)); })
